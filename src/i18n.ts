  ...
  resources: {
    tr: {
      translation: {
        ...
        fillAllFields: "Uyarı: Lütfen formdaki tüm alanları eksiksiz doldurunuz. Girilen bilgiler, kan bağışı sürecinde doğru ve hızlı iletişim kurulabilmesi için gereklidir.",
        phoneNumberInvalid: "Lütfen geçerli bir telefon numarası giriniz. Numara başında “0” olacak şekilde 11 haneli olmalıdır (örn. 05XX XXX XX XX)",
    ...
    en: {
      translation: {
        ...
        fillAllFields: "Warning: Please complete all required fields. Accurate and complete information is essential for ensuring fast and correct communication during the blood donation process.",
        phoneNumberInvalid: "Please enter a valid phone number. The number must be 11 digits, starting with “0” (e.g., 05XX XXX XX XX)",
